...
public class repositoryFileReader {
    public static ArrayList<String> findElementRepo(String elementIdentifier) {
        ...
        //Query execute
        String strQuery = "SELECT * FROM " + constantConfigs.locatorsWorksheet + " WHERE ElementID = '" + elementIdentifier+"'";
    ...
    public static By constructElement(ArrayList<String> locatorInformation) {
        ...
        switch (method) {
            ...
            default -> throw new RuntimeException("Locator type is unknown ");
        }
